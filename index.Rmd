...
The percent of births attended by a skilled physician was downloaded directly from [Gap Minder](https://www.gapminder.org/data/) which is a collection of datasets from several sources including the World Health Organization. 
...
### Maternal Mortality
The World Health Organization defined maternal mortality ratio (MMR) as the number of maternal deaths per 100,000 births. this is done because the ratio is relatively small. This maternal mortality rates in the US were also not directly available. To circumvent this, we used the number of maternal deaths per state and divided this by the number of births per state to get a ratio of maternal deaths per birth. Then, we scaled this number by multiplying by 100,000 which gives the number of maternal death per 100,000 births for consistency with the statistics reported by the world health organization.
