...
# Output map
   = states %>% 
    ...
    addPolygons(
      ...
      fillColor = ~pal(year_df$mortality_per_100000_births),
      weight = 2,
      opacity = 1,
      color = "white",
      dashArray = "3",
      ...
      labelOptions = labelOptions(
        ...
        direction = "auto")) %>%
    addLegend(pal = pal, 
              values = year_df$mortality_per_100000_births, 
              position = "bottomright", 
              title = "Maternal Mortality")
  titlePanel("Maternal Mortality Over Time"),
=======

interactive_child_birth_cost
>>>>>>> ec3f7be31a80fa5ca85cf45462082ff127125a54
```
