...
ten_developed_countries_maternal_mort = 
  ...
  labs(x = "Developed countries",
       ...
       title = "Inequality of US healthcare spending and maternal mortality")

interactive_maternal_mortality = ggplotly(ten_developed_countries_maternal_mort)
```

## Combine two interactive graphs
```{r}
subplot(interactive_healthcare_spending, interactive_maternal_mortality)
```
