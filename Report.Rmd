...
The scatterplot shows that globally, `ln(GDP per capita)` is approximately inversely associated with `Maternal Mortality Ratio per 100,000 live births`. From this overview, we see that GDP per capita can be a strong predictor of maternal mortality ratio at global level.
