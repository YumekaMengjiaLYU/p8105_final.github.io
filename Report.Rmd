...
>>>>>>> b0df01967a207e665c2af854f046613741ac9da0
...
# Maternal Mortality Ratio and GDP per capita
...
GDP per capita stands for Gross Domestic Product per person. It is an important indicator of economic performance and a useful unit to make cross-country comparisons of average living standards and economic wellbeing. In our project, GDP per capita is a factor to show its relationship with maternal mortality ratio across countries.
...
We specifically include a new variable `ln_gdp_per_capita`, the log-transformed `gdp_per_capita` to show a more linear relationship rather than a skewed distribution with maternal mortality ratio.
