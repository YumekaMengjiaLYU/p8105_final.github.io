...
It is also important to note that the number of births was only calculated from 2018 whereas the underlying cause of death dataset extends from 1999-2017. Given the time constraints of this project, the number of births per state for 2018 was used to normalize the deaths for every year from 1999-2017. However, we acknowledge that it would be better practice to calculate the number of births in each year from 1999-2017 and use this year-specific number when calculating the maternal mortality ratio (per 100,000 deaths) in each of these years.
...
Another observation worth highlighting was that despite the US investing massive amount of money in its healthcare system, it still has the highest maternal mortality ratio when commpared to the rest of the developed nations.

In the future, it might be interesting to look at differing maternal mortality ratios between populations, those who have cesarean sections and those who do not. However, the population specific data to perform these studies is not available at this time.